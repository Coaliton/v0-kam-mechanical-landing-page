...
export const metadata: Metadata = {
  ...
  description: "Professional residential mechanical services including AC installation, heating systems, plumbing, and 24/7 emergency repairs. Licensed technicians, satisfaction guaranteed.",
